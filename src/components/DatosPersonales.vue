...
const title = 'Mauro Gonzalez';
const descripcion = 'Técnico Universitario en Programación - UTN';
const residencia = 'San Miguel de Tucuman, Tucuman';
...
const redesSociales = [
  { id: 1, name: 'linkedin', src: linkedin, url: 'https://www.linkedin.com/in/meg/' },
  { id: 2, name: 'Instagram', src: instagram, url: 'https://www.instagram.com/joseperez/' },
  { id: 3, name: 'github', src: github, url: 'https://github.com/megon1' },
  { id: 4, name: 'curriculum', src: cv, url: '/public/CV MEG TESTING.pdf' },
];
const telefono = '+543813859443';
</script>
